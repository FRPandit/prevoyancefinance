...
final class Version20211102135319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movable_heritage (id INT AUTO_INCREMENT NOT NULL, detained_by VARCHAR(120) DEFAULT NULL, open_date DATE DEFAULT NULL, amount INT DEFAULT NULL, organization VARCHAR(120) NOT NULL, interest_rate INT DEFAULT NULL, monthly_annual_payment VARCHAR(50) DEFAULT NULL, goal VARCHAR(120) DEFAULT NULL, beneficiary VARCHAR(120) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
