...
final class Version20211021122455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE part_one (id INT AUTO_INCREMENT NOT NULL, donation TINYINT(1) NOT NULL, testament TINYINT(1) NOT NULL, notary TINYINT(1) NOT NULL, notary_name VARCHAR(120) DEFAULT NULL, donation_between_spouses TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
