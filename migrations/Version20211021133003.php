...
final class Version20211021133003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evolution (id INT AUTO_INCREMENT NOT NULL, evolution_choice TINYINT(1) NOT NULL, year INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE part_two (id INT AUTO_INCREMENT NOT NULL, active_company_savings_plan TINYINT(1) DEFAULT NULL, actual_saving INT DEFAULT NULL, contribution_class TINYINT(1) NOT NULL, contribution_class_label VARCHAR(15) DEFAULT NULL, trusted_account TINYINT(1) NOT NULL, trusted_account_name VARCHAR(120) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salary (id INT AUTO_INCREMENT NOT NULL, amount INT DEFAU   LT NULL, gross_net TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
