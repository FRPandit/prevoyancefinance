...
final class Version20211021145302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE part_one ADD objective_id INT NOT NULL, ADD intelligence_id INT NOT NULL, ADD share_in_company_id INT DEFAULT NULL, ADD status_id INT NOT NULL, ADD maried_id INT DEFAULT NULL, ADD children_id INT NOT NULL, ADD pro_status_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE pro_status ADD future_income_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pro_status ADD CONSTRAINT FK_DD02E94BC4420662 FOREIGN KEY (future_income_id) REFERENCES future_income (id)');
        $this->addSql('CREATE INDEX IDX_DD02E94BC4420662 ON pro_status (future_income_id)');
        $this->addSql('ALTER TABLE salary ADD future_income_id INT DEFAULT NULL, CHANGE amount amount INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE part_one DROP objective_id, DROP intelligence_id, DROP share_in_company_id, DROP status_id, DROP maried_id, DROP children_id, DROP pro_status_id');
